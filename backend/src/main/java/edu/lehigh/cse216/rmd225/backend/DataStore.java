...
public class DataStore {
     ...
     */
    public synchronized int createEntry(String title, String content, String attachment, String link, int likeCount, int dislikes, int total, int usrid) {
        ...
        int id = mCounter++;
        DataRow data = new DataRow(id,title,content, likeCount, dislikes, total,usrid, attachment, link);
        mRows.add(id, data);
        return id;
    }
